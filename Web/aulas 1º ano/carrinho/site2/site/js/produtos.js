...
function frete(quantidade) {
    ...
    if ((quantidade >= 1) && (quantidade <= 2)) {
        ...
        document.getElementById("frete").innerHTML = "Frete: R$" + quantidade * 1.99;

    }

    if ((quantidade >= 3) && (quantidade <= 5)) {

        document.getElementById("frete").innerHTML = "Frete: R$" + quantidade * 1.54;

    }

    if (quantidade > 5) {

        document.getElementById("frete").innerHTML = "Frete: R$" + quantidade * 0.99;
